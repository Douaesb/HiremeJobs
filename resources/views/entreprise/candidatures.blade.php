        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="ml-4 p-6 text-gray-900 dark:text-gray-100">
                    <div
                        class="block text-white bg-purple-700 w-48  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <div class="-mx-4 flex flex-wrap p-8">
                    ...
                    <div class="px-4 md:w-1/2 lg:w-1/3">
                        <div
                            ...
                            @foreach ($emploi as $offre)
                            <h2>{{ $offre->titre }}</h2>
                            <ul>
                                @foreach ($offre->chercheurs as $chercheur)
                                    <li>{{ $chercheur->name }} - {{ $chercheur->email }}</li>
                                @endforeach
                            </ul>
                        @endforeach
