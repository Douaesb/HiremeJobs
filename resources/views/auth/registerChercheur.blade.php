        ...
        <div class="flex justify-center items-center lg:order-2 gap-4">
            @guest
                ...
                <a href="{{ url('registerEntreprise') }}"
                    class="text-gray-800 border hover:bg-purple-100 border-purple-700 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Entreprise</a>
                <a href="{{ url('registerChercheur') }}"
                    class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Chercheur
                    d'emploi
                </a>
            @else
                <a href="{{ url('logout') }}"
