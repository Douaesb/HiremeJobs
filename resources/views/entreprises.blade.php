                    ...
                    <div class="relative flex items-center w-fit h-12 rounded-lg shadow-lg overflow-hidden">
                        ...
                        <form action="{{ route('entreprises') }}" method="GET">
                            <div class="flex justify-between">
                                <input name="search" class="h-full w-full text-sm text-gray-700 border-0" type="text" id="search" placeholder="Search job offer.." />
                                <button type="submit" class="bg-purple-400 w-24 text-white hover:bg-purple-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Search</button>
                            </div>
                        </form>
                    </div>
                </div>
